...
#from mycroft.audio import wait_while_speaking ##can put back?
...
#Empty own file before interaction
#with open('./workshop/community/claire.txt', "w") as f: #Should then activate
    #f.write("")
...
def interactLoop():
    ...
    ##Here Because mic not working, here send a question to VA
    client.run_in_thread()

    question="Tell me about black lives matter."
    print(question)
